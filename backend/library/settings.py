...
SECRET_KEY = 'django-insecure-yaiha9=g29bjdu1z8rq$)=l%c!2ub#)r@5vz0m3@(*mix8+vdh'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.getenv('POSTGRES_PASSWORD', 'library123'),
...
DEBUG = os.getenv('DEBUG', 'False') == 'True'  # Используем переменную из .env
